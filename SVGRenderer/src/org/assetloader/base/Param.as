package org.assetloader.base 
{
	...
	public class Param implements IParam
	{
		...
		/**
		 * Set true if you DON'T want the asset to from part of the loading queue except priority is beyond 0.
		 * 
		 * <p>Use: All asset types.</p>
		 * <p>Type: <code>Boolean</code></p>
		 * <p>Default: false</p>
		 * <p>Children ILoader of IAssetLoader will NOT inherit this param.</p>
		 */
		public static const BASE_PRIORITY : String = "BASE_PRIORITY";
